...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Wed Nov 20 21:55:39 CET 2013
  */
public class CalculetteParser extends java_cup.runtime.lr_parser {
  ...
  protected static final short[][] _action_table = 
    unpackFromStrings(new String[] {
    "\000\035\000\006\034\007\040\004\001\002\000\020\017" +
    "\ufffe\020\ufffe\021\ufffe\022\ufffe\023\ufffe\027\ufffe\032\ufffe" +
    "\001\002\000\004\027\035\001\002\000\004\002\034\001" +
    "\002\000\004\040\004\001\002\000\004\027\011\001\002" +
    "\000\012\020\015\036\017\037\014\040\004\001\002\000" +
    "\016\017\022\020\023\021\025\022\024\023\021\032\033" +
    "\001\002\000\016\017\ufff5\020\ufff5\021\ufff5\022\ufff5\023" +
    "\ufff5\032\ufff5\001\002\000\016\017\ufffc\020\ufffc\021\ufffc" +
    "\022\ufffc\023\ufffc\032\ufffc\001\002\000\012\020\015\036" +
    "\017\037\014\040\004\001\002\000\016\017\ufff4\020\ufff4" +
    "\021\ufff4\022\ufff4\023\ufff4\032\ufff4\001\002\000\016\017" +
    "\ufffd\020\ufffd\021\ufffd\022\ufffd\023\ufffd\032\ufffd\001\002" +
    "\000\016\017\ufff6\020\ufff6\021\ufff6\022\ufff6\023\ufff6\032" +
    "\ufff6\001\002\000\012\020\015\036\017\037\014\040\004" +
    "\001\002\000\012\020\015\036\017\037\014\040\004\001" +
    "\002\000\012\020\015\036\017\037\014\040\004\001\002" +
    "\000\012\020\015\036\017\037\014\040\004\001\002\000" +
    "\012\020\015\036\017\037\014\040\004\001\002\000\016" +
    "\017\ufff9\020\ufff9\021\ufff9\022\ufff9\023\ufff9\032\ufff9\001" +
    "\002\000\016\017\ufff8\020\ufff8\021\ufff8\022\ufff8\023\ufff8" +
    "\032\ufff8\001\002\000\016\017\ufffa\020\ufffa\021\025\022" +
    "\024\023\021\032\ufffa\001\002\000\016\017\ufffb\020\ufffb" +
    "\021\025\022\024\023\021\032\ufffb\001\002\000\016\017" +
    "\ufff7\020\ufff7\021\ufff7\022\ufff7\023\ufff7\032\ufff7\001\002" +
    "\000\004\002\000\001\002\000\004\002\001\001\002\000" +
    "\012\020\015\036\017\037\014\040\004\001\002\000\016" +
    "\017\022\020\023\021\025\022\024\023\021\032\037\001" +
  ...
  public final java_cup.runtime.Symbol CUP$CalculetteParser$do_action(
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$CalculetteParser$act_num)
		...
		int expright = ((java_cup.runtime.Symbol)CUP$CalculetteParser$stack.peek()).right;
		Expression exp = (Expression)((java_cup.runtime.Symbol) CUP$CalculetteParser$stack.peek()).value;
		 RESULT = new OperationArithmetique(exp, EnumOp.MINUS_U);   
		...
		Expression e2 = (Expression)((java_cup.runtime.Symbol) CUP$CalculetteParser$stack.peek()).value;
		 RESULT = new OperationArithmetique(e1, e2, EnumOp.MOD);    
		...
		int e2right = ((java_cup.runtime.Symbol)CUP$CalculetteParser$stack.peek()).right;
		Expression e2 = (Expression)((java_cup.runtime.Symbol) CUP$CalculetteParser$stack.peek()).value;
		 RESULT = new OperationArithmetique(e1, e2, EnumOp.DIVIDE); 
              CUP$CalculetteParser$result = parser.getSymbolFactory().newSymbol("expression_arith",3, ((java_cup.runtime.Symbol)CUP$CalculetteParser$stack.elementAt(CUP$CalculetteParser$top-2)), ((java_cup.runtime.Symbol)CUP$CalculetteParser$stack.peek()), RESULT);
            }
          return CUP$CalculetteParser$result;
		...
		int e2right = ((java_cup.runtime.Symbol)CUP$CalculetteParser$stack.peek()).right;
		Expression e2 = (Expression)((java_cup.runtime.Symbol) CUP$CalculetteParser$stack.peek()).value;
		 RESULT = new OperationArithmetique(e1, e2, EnumOp.TIMES);  
              CUP$CalculetteParser$result = parser.getSymbolFactory().newSymbol("expression_arith",3, ((java_cup.runtime.Symbol)CUP$CalculetteParser$stack.elementAt(CUP$CalculetteParser$top-2)), ((java_cup.runtime.Symbol)CUP$CalculetteParser$stack.peek()), RESULT);
            }
          return CUP$CalculetteParser$result;
		...
		int e2right = ((java_cup.runtime.Symbol)CUP$CalculetteParser$stack.peek()).right;
		Expression e2 = (Expression)((java_cup.runtime.Symbol) CUP$CalculetteParser$stack.peek()).value;
		 RESULT = new OperationArithmetique(e1, e2, EnumOp.MINUS);  
              CUP$CalculetteParser$result = parser.getSymbolFactory().newSymbol("expression_arith",3, ((java_cup.runtime.Symbol)CUP$CalculetteParser$stack.elementAt(CUP$CalculetteParser$top-2)), ((java_cup.runtime.Symbol)CUP$CalculetteParser$stack.peek()), RESULT);
            }
          return CUP$CalculetteParser$result;
		...
		int e2right = ((java_cup.runtime.Symbol)CUP$CalculetteParser$stack.peek()).right;
		Expression e2 = (Expression)((java_cup.runtime.Symbol) CUP$CalculetteParser$stack.peek()).value;
		 RESULT = new OperationArithmetique(e1, e2, EnumOp.PLUS);   
              CUP$CalculetteParser$result = parser.getSymbolFactory().newSymbol("expression_arith",3, ((java_cup.runtime.Symbol)CUP$CalculetteParser$stack.elementAt(CUP$CalculetteParser$top-2)), ((java_cup.runtime.Symbol)CUP$CalculetteParser$stack.peek()), RESULT);
            }
          return CUP$CalculetteParser$result;
